...
def main():
    # Read files
    team_profiles_df = pd.read_csv('team_profiles_en.csv', delimiter=';')
    navigator_data_df = pd.read_csv('navigator_data_en.csv', delimiter=';')
    ...
    # Save as JSON
    output_file = 'team_profiles_with_projects_en.json'
