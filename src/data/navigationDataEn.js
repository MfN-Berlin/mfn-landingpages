    ...
    submenuColumns: [
      {
        ...
        items: [
          {
            to: "/en/visit/exhibitions",
            label: "Exhibitions",
            order: 1,
            submenu: [
              { to: "/en/museum/exhibitions/zugvogel", label: "ZUGvögel" },
              { to: "/en/museum/exhibitions/zukunftsplan", label: "Zukunftsplan" },
              { to: "/en/museum/exhibitions/dinosaurs-age-giant-lizards", label: "Dinosaurs!" },
              { to: "/en/museum/exhibitions/digitize", label: "digitize!" },
              { to: "/en/museum/exhibitions/world-dinosaurs", label: "The World of Dinosaurs" },
              { to: "/en/museum/exhibitions/system-earth", label: "System Earth" },
              { to: "/en/museum/exhibitions/cosmos-and-solar-system", label: "The Cosmos and the Solar System" },
              { to: "/en/museum/exhibitions/evolution-action", label: "Evolution in Action" },
              { to: "/en/museum/exhibitions/wet-collection", label: "Wet Collection" },
              { to: "/en/museum/exhibitions/kellers-insect-models", label: "Keller's Insect Models" },
              { to: "/en/museum/exhibitions/highlights-taxidermy", label: "Highlights of taxidermy" },
              { to: "/en/museum/exhibitions/minerals", label: "Minerals" },
              { to: "/en/museum/exhibitions/humboldt-intervention", label: "Humboldt Intervention" },
              { to: "/en/museum/touring-exhibitions", label: "Touring Exhibitions" },
              { to: "/en/museum/exhibitions/archive-special-exhibition", label: "Archive: Special Exhibition" }
            ]
          }
        ]
      },
      {
        ...
        items: [
          {
            to: "/en/museum/furnatur-digital",
            label: "#fürNatur digital",
            order: 1,
            submenu: [
              { to: "/en/museum/furnatur-digital/beats-bones-podcast-museum-fur-naturkunde-berlin", label: "Podcast Beats & Bones" },
              { to: "/en/museum/furnatur-digital/queering-nature", label: "Queering Nature" },
              { to: "/en/museum/furnatur-digital/susses-oder-saurier-kids-podcast-museum-fur-naturkunde-berlin", label: "Podcast Süßes oder Saurier" },
              { to: "/en/museum/furnatur-digital/grass.-a-literary-audio-guide-anthropocene", label: "Wie Gras" }
            ]
          }
        ]
      },
